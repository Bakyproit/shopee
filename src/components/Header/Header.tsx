        ...
        <div className='flex justify-end'>
          ...
          {isAuthenticated && (
            <Popover
              // initalOpen
              placement='bottom-end'
              className='cursos-pointer ml-6 flex items-center py-1 hover:text-white/70'
              renderPopover={
                <div className='relative rounded-sm  border-gray-200 bg-white shadow-md'>
                  <Link
                    to={path.profile}
                ...
                <div className='relative max-w-[400px]  rounded-sm border-gray-200 bg-white text-sm shadow-md'>
                  <div className='p-2'>
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        ...
                        <div className='ml-2 flex-grow overflow-hidden'>
                          <div className='truncate'>Day la san pham moi cua noi com dien haah scbkjdhs 37438743</div>
                        </div>
                    ...
                    <div className='mt-6 flex items-center justify-between'>
                      <div className='text-xs capitalize text-gray-500'>Thêm vào giở hàng</div>
